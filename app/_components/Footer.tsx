          ...
          <form onSubmit={handleSubscribe} className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                style={{ borderColor: subState === "error" ? "#FF3333" : "rgba(255,255,255,0.08)" }}
                onFocus={(e) => (e.currentTarget.style.borderColor = "#00FF41")}
                onBlur={(e) => (e.currentTarget.style.borderColor = subState === "error" ? "#FF3333" : "rgba(255,255,255,0.08)")}
              />
              <button
                type="submit"
              ...
              >
                {subState === "loading" ? "…" : subState === "done" ? "✓" : "Join"}
              </button>
            </div>
            {subState === "done" && (
              <p className="text-[11px] text-[#00FF41]">You&apos;re on the list. See you under the neon lights 🌙</p>
            )}
            {subState === "error" && (
              <p className="text-[11px] text-[#FF3333]">Something went wrong — try again.</p>
            )}
          </form>
        </div>
      </div>
